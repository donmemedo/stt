...
parser.add_argument('--data_path', default='/home/makhataei/Projects/STT/test/1', type=str)
...
if __name__ == '__main__':
    ...
    main(r'/home/makhataei/Projects/STT/test/1/4527484.wav', embedding_per_second=1.2, overlap_rate=0.4)
